...
public static class UIColors
{
	...
	public static readonly Color HoverBg = new(0.18f, 0.18f, 0.24f);
	public static readonly Color SelectedBg = new(0.13f, 0.22f, 0.17f);
	...
	public static readonly Color IdleBorder = new(0.22f, 0.22f, 0.26f);
