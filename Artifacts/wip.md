...
- qtwx-mcp-6 | App/Main.Startup.cs(InitializeCoreServices) + App/Main.Timeline.cs(ApplyTimelineStep 仅一行) + MiniRPG.Shared/Core/AI/Utility/InputResolver.cs + MiniRPG.Shared/Core/Social/{RelationshipModule,ActorMemoryModule,RumorBus}.cs + Data/Config/utility_actions.json(flee_combat) + Tests/MiniRPG.Tests/InputResolverSocialTests.cs + Docs/涌现世界路线图.md | 涌现社交管线接通（P0-2/P0-3/P0-4/P1-23 路线图第 1-4 步接线度 0%→30%） 2026-04-19
