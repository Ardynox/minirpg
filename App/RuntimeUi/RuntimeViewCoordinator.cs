...
internal sealed class RuntimeViewCoordinator
{
		...
		Action markUiDirty)
	{
		...
		_ui.MapRender.HoverWorldCell = mapEditorActive && mapEditorHoverWorld.HasValue
			? new Vector3I(mapEditorHoverWorld.Value.X, mapEditorHoverWorld.Value.Y, editorZ)
			: hoverWorldCell;
