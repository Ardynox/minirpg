...
public static class PlaceholderWorkspaceCatalog
{
	...
	private static readonly IReadOnlyDictionary<string, StarterText> StarterTextById = new Dictionary<string, StarterText>(StringComparer.OrdinalIgnoreCase)
	{
		...
		["npc_elf_trader"] = new("精灵商人地图占位图", "精灵商人的地图像素占位图。"),
		["npc_orc_merchant"] = new("兽人商人地图占位图", "兽人商人的地图像素占位图。"),
	...
	[
		...
		CreateStarterEntry(NpcMapCategory, "npc_elf_trader", Tile256PresetId, "friendly", "elf", "merchant", "trader"),
		CreateStarterEntry(NpcMapCategory, "npc_orc_merchant", Tile256PresetId, "friendly", "orc", "merchant"),
